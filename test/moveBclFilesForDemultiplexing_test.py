...
class MiSeqRunInfo(unittest.TestCase):
  def setUp(self):
    self.input_dir  = mkdtemp()
    self.output_dir = mkdtemp()
    sample_sheet    = 'doc/data/SampleSheet/MiSeq/SampleSheet.csv'
    run_info_xml    = 'doc/data/Illumina/MiSeqRunInfo.xml'
  ...
  def test_copy_bcl_files(self):
    ...
    self.assertTrue(os.path.exists(os.path.join(self.output_dir,'Data/Intensities/BaseCalls')),1)
