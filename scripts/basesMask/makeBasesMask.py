...
def calculate_bases_mask(samplesheet_file, runinfo_file, read_offset, index_offset):
  '''
...
bases_mask_value=calculate_bases_mask(samplesheet_file=samplesheet_file, runinfo_file=runinfo_file, read_offset=read_offset, index_offset=index_offset)
