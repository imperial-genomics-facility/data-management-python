...
class Experiment(Base):
  ...
  experiment_type   = Column(Enum('POLYA-RNA', 'TOTAL-RNA', 'SMALL-RNA', 'H3K4ME3', 'WGS', 'EXOME', 'H3k27ME3', 'H3K27AC', 'H3K9ME3', 'H3K36ME3', 'ATAC-SEQ','UNKNOWN'), nullable=False, server_default='UNKNOWN')
