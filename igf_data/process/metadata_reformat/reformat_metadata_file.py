...
[{'library_preparation': 'WHOLE GENOME SEQUENCING - SAMPLE', 'library_type': 'WHOLE GENOME',
 ...
 {'library_preparation': "SINGLE CELL -3' RNASEQ- SAMPLE", 'library_type': 'SINGLE CELL 3’ GENE EXPRESSION LIBRARIES',
  'library_strategy': 'RNA-SEQ', 'experiment_type': 'TENX-TRANSCRIPTOME-3P', 'library_source': 'TRANSCRIPTOMIC SINGLE CELL','biomaterial_type':'UNKNOWN'},
 {'library_preparation': "SINGLE CELL -3' RNASEQ- SAMPLE NUCLEI", 'library_type': 'SINGLE CELL 3’ GENE EXPRESSION LIBRARIES NUCLEI',
  'library_strategy': 'RNA-SEQ', 'experiment_type': 'TENX-TRANSCRIPTOME-3P', 'library_source': 'TRANSCRIPTOMIC SINGLE CELL','biomaterial_type':'SINGLE_NUCLEI'},
 {'library_preparation': "SINGLE CELL -5' RNASEQ- SAMPLE", 'library_type': 'SINGLE CELL 5’ GENE EXPRESSION LIBRARIES',
  'library_strategy': 'RNA-SEQ', 'experiment_type': 'TENX-TRANSCRIPTOME-5P', 'library_source': 'TRANSCRIPTOMIC SINGLE CELL','biomaterial_type':'UNKNOWN'},
 {'library_preparation': "SINGLE CELL -5' RNASEQ- SAMPLE NUCLEI", 'library_type': 'SINGLE CELL 5’ GENE EXPRESSION LIBRARIES NUCLEI',
  'library_strategy': 'RNA-SEQ', 'experiment_type': 'TENX-TRANSCRIPTOME-5P', 'library_source': 'TRANSCRIPTOMIC SINGLE CELL','biomaterial_type':'SINGLE_NUCLEI'},
